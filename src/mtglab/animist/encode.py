...
from mtglab.animist.recipe import VIDEO_FORMATS, Encode
...
def _video(sequence: FrameSequence, settings: Encode, *, codec: str,
    ...
    try:
        ...
        raise EncodeError("video encoding needs imageio-ffmpeg -- reinstall "
                          "the animist extra: `pip install -e '.[animist]'`") \
            from exc
    import numpy as np
