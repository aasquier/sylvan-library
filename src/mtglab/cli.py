...
def main(argv=None):
    ...
    l = sim.add_parser("lands"); l.add_argument("slug")
    l.add_argument("low", type=int); l.add_argument("high", type=int)
    l.add_argument("--games", type=int, default=5000)
    l.add_argument("--seed", type=int, default=7)
    l.set_defaults(func=cmd_sim_lands)
