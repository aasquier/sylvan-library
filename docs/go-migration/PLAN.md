...
left in Phase 5 is entirely the flips**, and their shape is already decided
by the generic-job-route row above: the first family flip carries the hybrid
poll handler, or all eight families and both generic routes move in one
change. **The GIL dividend is banked here, and cannot
