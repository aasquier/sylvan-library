...
| **Red** | Speed & Alarum | CI/CD pipeline; alerting & self-healing (the expiry calendar, the dated restore drill); **controls** — commandment 17 made checkable, because a control's virtue is the speed of its reply |
