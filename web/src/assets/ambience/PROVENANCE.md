...
- **Transformations** (Pillow, scripted -- `animist build mist.recipe.yaml`):
...
- **Licence**: ours-generated. Confirmed through nobody -- generated by this pipeline, no upstream to ask at fetch time (2026-08-16).
- **Transformations** (Pillow, scripted -- `animist build wisps.recipe.yaml`):
...
- **Licence**: ours-generated. Confirmed through nobody -- generated by this pipeline, no upstream to ask at fetch time (2026-08-16).
- **Transformations** (Pillow, scripted -- `animist build embers.recipe.yaml`):
