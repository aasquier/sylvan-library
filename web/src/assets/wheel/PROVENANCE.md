...
- **Transformations** (Pillow, scripted -- `animist build critter.recipe.yaml`):
...
.
- **Licence**: cc0. Confirmed through the Openverse record API at fetch time (2026-08-17).
- **Transformations** (Pillow, scripted -- `animist build menagerie.recipe.yaml`):
...
- **Transformations** (Pillow, scripted -- `animist build fates.recipe.yaml`):
...
.
- **Licence**: cc0. Confirmed through the Openverse record API at fetch time (2026-08-17).
- **Transformations** (Pillow, scripted -- `animist build lantern.recipe.yaml`):
...
.
- **Licence**: cc0. Confirmed through the Openverse record API at fetch time (2026-08-17).
- **Transformations** (Pillow, scripted -- `animist build shades.recipe.yaml`):
