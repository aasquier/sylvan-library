...
annotations). Pillow is a core dependency of the toolbox now, but the lazy
shape is kept: the ImportError of a broken install belongs at the moment
pixels are touched, where the CLI turns it into a reinstall instruction.
"""
